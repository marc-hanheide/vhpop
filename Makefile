...
ACLOCAL = ${SHELL} /data/phd/Phd/Merging/vhpop/missing aclocal-1.14
ALLOCA = 
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /data/phd/Phd/Merging/vhpop/missing autoconf
AUTOHEADER = ${SHELL} /data/phd/Phd/Merging/vhpop/missing autoheader
AUTOMAKE = ${SHELL} /data/phd/Phd/Merging/vhpop/missing automake-1.14
AWK = gawk
CC = gcc
...
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /data/phd/Phd/Merging/vhpop/missing makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = vhpop
PACKAGE_BUGREPORT = lorens@cs.cmu.edu
PACKAGE_NAME = VHPOP
...
YACC = bison -y
YFLAGS = 
abs_builddir = /data/phd/Phd/Merging/vhpop
abs_srcdir = /data/phd/Phd/Merging/vhpop
abs_top_builddir = /data/phd/Phd/Merging/vhpop
abs_top_srcdir = /data/phd/Phd/Merging/vhpop
ac_ct_CC = gcc
ac_ct_CXX = g++
am__include = include
am__leading_dot = .
...
install_sh = ${SHELL} /data/phd/Phd/Merging/vhpop/install-sh
